...
OUTPUT_PATH = "/mnt/datastore/data/tweets_medias_withURL.csv"
...
tweets_df = pd.DataFrame(columns=["tweet_id", "user_id", "user_name", "likes", "retweets", "text", "created_at", "url"])
...
for i in range(NB_TWEETS//API_GET_LIMIT + 1):
  ...
  for tweet in tweets:
    ...
    new_row = {"tweet_id": tweet_id, "user_id":user_id, "user_name":user_name, "likes":likes, 
